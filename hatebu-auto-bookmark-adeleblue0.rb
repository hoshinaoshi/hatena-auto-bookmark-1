...
tags = %w(bootstrap css css3 design font frontend git github html html5 javascript js node.js react ubuntu ui ux vue vue.js web webデザイン web制作 エディタ デザイン フォント フロントエンド 犬 かわいい 中国 写真 出版 アイドル)
