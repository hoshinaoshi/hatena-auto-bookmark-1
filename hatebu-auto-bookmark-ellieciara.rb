...
# db多め 敢えてノイズ入れる
tags = %w(aws ねこ 猫 database db 東京 dev development 京都 docker git github sql 機械学習 仕事 web webdesign コーヒー 犬 データサイエンス webpack webアプリケーション エンジニア コンテナ サーバ システム データ 設計 開発  データ分析 イラスト マンガ)
